                        ...
                        <fieldset>
                            ...
                            <div class=\"form-group\">
                                ...
                                <input id=\"fabricante\" class=\"form-control\" type=\"text\" name=\"fabricante\"
                                      placeholder=\"ex. DELL / IBM\" style=\"text-transform:uppercase\" autocomplete=\"off\"
                            ...
                            <div class=\"form-group\">
                                ...
                                <input id=\"nome\" class=\"form-control\" type=\"text\" name=\"nome\"
                                      placeholder=\"ex. COM3DN-WEB\" style=\"text-transform:uppercase\"
                            ...
                            <div class=\"form-group\">
                                ...
                                <select id=\"idtb_om_setores\" class=\"form-control\" name=\"idtb_om_setores\">
                                    <option value=\"$servidor->idtb_om_setores\" selected=\"true\">
                                            ".$servidor->sigla_setor." - ".$servidor->compartimento."</option>";
