                ...
                <fieldset>
                    ...
                    <div class=\"form-group\">
                        ...
                        <input id=\"clock_proc\" class=\"form-control\" type=\"number\" name=\"clock_proc\"
                            ...
                            value=\"$estacoes->clock_proc\" required=\"true\" autocomplete=\"off\">
                    </div>
                        ...
                        <option value=\"$estacoes->idtb_memorias\" selected=\"true\">
                            ...
                            foreach ($mem as $key => $value) {
                                echo"<option value=\"".$value->idtb_memorias."\">
                                    ".$value->tipo." - ".$value->modelo." - ".$value->clock."</option>";
                            };
                        echo "</select>
                    </div>

                    <div class=\"form-group\">
                        <label for=\"memoria\">Memória (Total GB):</label>
                        <input id=\"memoria\" class=\"form-control\" type=\"number\" name=\"memoria\"
                               placeholder=\"ex. 16\" value=\"$estacoes->memoria\" required=\"true\" autocomplete=\"off\">
                    </div>
                    ...
                    <div class=\"form-group\">
                        ...
                        <input id=\"end_ip\" class=\"form-control\" type=\"text\" name=\"end_ip\"
                               ...
                               value=\"$estacoes->end_ip\" maxlength=\"15\" required=\"true\" autocomplete=\"off\">
                    </div>
                    ...
                    <div class=\"form-group\">
                        ...
                        <input id=\"end_mac\" class=\"form-control\" type=\"text\" name=\"end_mac\"
                               ...
                               value=\"$estacoes->end_mac\" maxlength=\"23\" required=\"true\" autocomplete=\"off\">
                    </div>
