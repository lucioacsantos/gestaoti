...
-- gestaoti.tb_pessoal_gestor_ti definition

-- Drop table

-- DROP TABLE gestaoti.tb_pessoal_gestor_ti;

CREATE TABLE gestaoti.tb_pessoal_gestor_ti (
	idtb_pessoal_gestor_ti serial NOT NULL,
	...
	CONSTRAINT tb_pessoal_gestor_ti_pkey PRIMARY KEY (idtb_pessoal_gestor_ti),
	CONSTRAINT unico_cpf UNIQUE (cpf)
);
COMMENT ON TABLE gestaoti.tb_pessoal_gestor_ti IS 'Tabela contendo Pessoal de TI do Órgão Gestor.';

-- Permissions

ALTER TABLE gestaoti.tb_pessoal_gestor_ti OWNER TO gestaoti;
GRANT ALL ON TABLE gestaoti.tb_pessoal_gestor_ti TO gestaoti;
...
-- gestaoti.tb_qualif_pess_ti_orgao_gestor definition

-- Drop table

-- DROP TABLE gestaoti.tb_qualif_pess_ti_orgao_gestor;

CREATE TABLE gestaoti.tb_qualif_pess_ti_orgao_gestor (
	idtb_qualif_pess_ti_orgao_gestor serial NOT NULL,
	...
	situacao varchar(45) NOT NULL,
	idtb_pessoal_gestor_ti int4 NOT NULL,
	CONSTRAINT tb_qualif_pess_ti_orgao_gestor_pkey PRIMARY KEY (idtb_qualif_pess_ti_orgao_gestor),
	CONSTRAINT tb_qualif_pess_ti_orgao_gestor_idtb_pessoal_gestor_ti_fkey FOREIGN KEY (idtb_pessoal_gestor_ti) 
		REFERENCES gestaoti.tb_pessoal_gestor_ti(idtb_pessoal_gestor_ti)
);
COMMENT ON TABLE gestaoti.tb_qualif_pess_ti_orgao_gestor IS 'Tabela contendo Qualificação do Pessoal do Gestor de TI.';

-- Permissions

ALTER TABLE gestaoti.tb_qualif_pess_ti_orgao_gestor OWNER TO gestaoti;
GRANT ALL ON TABLE gestaoti.tb_qualif_pess_ti_orgao_gestor TO gestaoti;
...
-- gestaoti.tb_diretor_ti definition

-- Drop table

-- DROP TABLE gestaoti.tb_diretor_ti;

CREATE TABLE gestaoti.tb_diretor_ti (
	idtb_diretor_ti serial NOT NULL,
	...
	CONSTRAINT tb_diretor_ti_pkey PRIMARY KEY (idtb_diretor_ti),
	CONSTRAINT tb_diretor_ti_idtb_orgaos_apoiados_fkey FOREIGN KEY (idtb_orgaos_apoiados) 
		REFERENCES gestaoti.tb_orgaos_apoiados(idtb_orgaos_apoiados)
);
COMMENT ON TABLE gestaoti.tb_diretor_ti IS 'Tabela contendo Diretores de TI dos Órgãos.';

-- Permissions

ALTER TABLE gestaoti.tb_diretor_ti OWNER TO gestaoti;
GRANT ALL ON TABLE gestaoti.tb_diretor_ti TO gestaoti;
...
-- gestaoti.tb_pess_ti_orgaos definition

-- Drop table

-- DROP TABLE gestaoti.tb_pess_ti_orgaos;

CREATE TABLE gestaoti.tb_pess_ti_orgaos (
	idtb_pess_ti_orgaos serial NOT NULL,
	idtb_orgaos_apoiados int4 NOT NULL,
	cpf varchar(11) NOT NULL,
	nome varchar(255) NOT NULL,
	nome_guerra varchar(255) NOT NULL,
	...
	CONSTRAINT tb_pess_ti_orgaos_pkey PRIMARY KEY (idtb_pess_ti_orgaos),
	CONSTRAINT tb_pess_ti_orgaos_idtb_funcoes_ti_fkey FOREIGN KEY (idtb_funcoes_ti) 
		REFERENCES gestaoti.tb_funcoes_ti(idtb_funcoes_ti),
	CONSTRAINT tb_pess_ti_orgaos_idtb_orgaos_apoiados_fkey FOREIGN KEY (idtb_orgaos_apoiados) 
		REFERENCES gestaoti.tb_orgaos_apoiados(idtb_orgaos_apoiados)
);
COMMENT ON TABLE gestaoti.tb_pess_ti_orgaos IS 'Tabela contendo Pessoal de TI dos Órgãos.';

-- Permissions

ALTER TABLE gestaoti.tb_pess_ti_orgaos OWNER TO gestaoti;
GRANT ALL ON TABLE gestaoti.tb_pess_ti_orgaos TO gestaoti;


-- gestaoti.tb_qualificacao_ti definition

-- Drop table

-- DROP TABLE gestaoti.tb_qualificacao_ti;

CREATE TABLE gestaoti.tb_qualificacao_ti (
	...
	meio varchar(255) NOT NULL,
	situacao varchar(45) NOT NULL,
	idtb_pess_ti_orgaos int4 NOT NULL,
	CONSTRAINT tb_qualificacao_ti_pkey PRIMARY KEY (idtb_qualificacao_ti),
	CONSTRAINT tb_qualificacao_ti_idtb_pess_ti_orgaos_fkey FOREIGN KEY (idtb_pess_ti_orgaos) 
		REFERENCES gestaoti.tb_pess_ti_orgaos(idtb_pess_ti_orgaos)
);
COMMENT ON TABLE gestaoti.tb_qualificacao_ti IS 'Tabela contendo Qualificação do Pessoal de TI dos Órgãos.';

-- Permissions

ALTER TABLE gestaoti.tb_qualificacao_ti OWNER TO gestaoti;
GRANT ALL ON TABLE gestaoti.tb_qualificacao_ti TO gestaoti;
...
CREATE TABLE gestaoti.tb_dias_troca (
		...
		CONSTRAINT tb_dias_troca_fk_1 FOREIGN KEY (idtb_pess_ti_orgaos) 
			REFERENCES gestaoti.tb_pess_ti_orgaos(idtb_pess_ti_orgaos)
	);
...
-- gestaoti.tb_dias_troca_orgao_gestor definition

-- Drop table

-- DROP TABLE gestaoti.tb_dias_troca_orgao_gestor;

CREATE TABLE gestaoti.tb_dias_troca_orgao_gestor (
		idtb_dias_troca_orgao_gestor serial NOT NULL,
		idtb_pessoal_gestor_ti int4 NOT NULL,
		dias_troca int4 NOT NULL,
		CONSTRAINT tb_dias_troca_orgao_gestor_pkey PRIMARY KEY (idtb_dias_troca_orgao_gestor),
		CONSTRAINT tb_dias_troca_orgao_gestor_fk_1 FOREIGN KEY (idtb_pessoal_gestor_ti) 
			REFERENCES gestaoti.tb_pessoal_gestor_ti(idtb_pessoal_gestor_ti)
	);
COMMENT ON TABLE gestaoti.tb_dias_troca_orgao_gestor IS 'Tabela contendo Dias para Troca de Senha do Órgão Gestor';

-- Permissions

ALTER TABLE gestaoti.tb_dias_troca_orgao_gestor OWNER TO gestaoti;
GRANT ALL ON TABLE gestaoti.tb_dias_troca_orgao_gestor TO gestaoti;
